...
print("Loading fine-tuned LoRA BERT model and tokenizer...")
tokenizer = BertTokenizerFast.from_pretrained('./best_lora')
model = BertModel.from_pretrained('./best_lora')
model.eval()
...
def make_word_embeddings(word_list, chunk_size=400):
    """
    Generate word embeddings for a list of words using LoRA-fine-tuned BERT.
